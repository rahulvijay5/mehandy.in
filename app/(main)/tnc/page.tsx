    ...
    <main className="min-h-screen bg-white py-16">
      <div className="container-custom max-w-4xl mx-auto px-4">
        <div className="bg-[#FFF6EA] p-8 md:p-12 rounded-xl shadow-lg">
          <h1 className="title-font text-4xl md:text-5xl text-[#FF4B91] mb-8 text-center">
            Terms &amp; Conditions
          </h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-6">
              ...
              of domain name mehandy.in (&apos;Website&apos;), including the
              related mobile site and mobile application (hereinafter referred
              to as &apos;Platform&apos;).
            </p>

            <p className="mb-6">
              The Platform is owned by Mehandy, a company incorporated under the
              Companies Act, 1956 with its registered office at NEW CLOTH
              MARKET, MAHAVEER COLONY, Chittorgarh, India (hereinafter referred
            ...
            <p className="mb-6">
              ...
              binding obligations, with Platform Owner. These Terms of Use
              relate to your use of our website, goods (as applicable) or
              services (as applicable) (collectively, &apos;Services&apos;). Any
              terms and conditions proposed by You which are in addition to or
              which conflict with these Terms of Use are expressly rejected by
              the Platform Owner and shall be of no force or effect.
            </p>
            ...
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-6">
            ...
            <p><span className="font-bold">Owner Name:</span> Tanisha Vijayvergiya</p>
            <p><span className="font-bold">Contact:</span> 7725963171</p>
            <p><span className="font-bold">Email: </span>tanishamehanditutorial@gmail.com</p>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex space-x-4">
                <Link
                  href="/privacy-policy"
                  className="text-[#FF4B91] hover:underline"
                >
                  Privacy Policy
                </Link>
                <Link
