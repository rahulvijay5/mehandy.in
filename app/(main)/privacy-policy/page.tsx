    ...
    <main className="min-h-screen bg-white py-16">
      <div className="container-custom max-w-4xl mx-auto px-4">
        <div className="bg-[#FFF6EA] p-8 md:p-12 rounded-xl shadow-lg">
          <h1 className="title-font text-4xl md:text-5xl text-[#FF4B91] mb-8 text-center">Privacy Policy</h1>
          
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl text-[#FF4B91] font-bold mb-4">Introduction</h2>
            <p className="mb-6">
              This Privacy Policy describes how Mehandy and its affiliates (collectively &quot;we, our, us&quot;)
              collect, use, share, protect or otherwise process your information/personal data through our website
              mehandy.in (hereinafter referred to as &quot;Platform&quot;). Please note that you may be able to browse certain
            ...
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Collection</h2>
            <p className="mb-6">
            ...
            <div className="bg-[#ffecda] p-6 rounded-lg my-8">
              <p className="font-semibold">
                If you receive an email, a call from a person/association claiming to be Mehandy
                seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we
                request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.
              </p>
            </div>
            
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Usage</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Sharing</h2>
            <p className="mb-6">
            ...
            <p className="mb-6">
              We may disclose personal and sensitive personal data to government agencies or other authorised law enforcement agencies if required to do so by law or in the good faith
            ...
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Security Precautions</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Data Deletion and Retention</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Your Rights</h2>
            <p className="mb-6">
              You may access, rectify, and update your personal data directly through the functionalities
              provided on the Platform.
            </p>
            
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Consent</h2>
            <p className="mb-6">
            ...
            <p className="mb-6">
              You have an option to withdraw your consent that you have already provided by writing to the Grievance Officer at the
            ...
            <h2 className="text-2xl text-[#FF4B91] font-bold mt-8 mb-4">Changes to this Privacy Policy</h2>
            <p className="mb-6">
